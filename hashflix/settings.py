...
SECRET_KEY = 'django-insecure-n%_utc)=lan^i$!mgwc7+d=a*83z--s5$!xl_nxe_$=077k&37'
...
INSTALLED_APPS = [
    ...
    'filme', #conectar ao apps de filme
    'crispy_forms',
    'crispy_bootstrap5',
]
...
AUTH_USER_MODEL = "filme.Usuario" #filme => nome do app,  Usuario => classe usuario dentro de models
